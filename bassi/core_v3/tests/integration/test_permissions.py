...
class TestPermissionManager:
    ...
    @pytest.mark.asyncio
    async def test_global_bypass_allows_all_tools(self, permission_manager, config_service):
        """
        ...
        for tool_name in tools:
            ...
            assert isinstance(result, PermissionResultAllow), f"Global bypass should allow {tool_name}"
        ...
        assert isinstance(result, PermissionResultAllow), "Global bypass should override other permissions"
    
    @pytest.mark.asyncio
    async def test_one_time_permission(self, permission_manager, config_service):
        """
    ...
    @pytest.mark.asyncio
    async def test_one_time_permission_multiple_uses(self, permission_manager, config_service):
        """
    ...
    @pytest.mark.asyncio
    async def test_persistent_permission(self, permission_manager, config_service):
...
class TestPermissionScopes:
    ...
    @pytest.mark.asyncio
    async def test_permission_scope_priority(self, permission_manager, config_service):
        """
